...
vendor/napodan/prebuilt/gapps/system/lib/libpatts_engine_jni_api.so:system/lib/libpatts_engine_jni_api.so \
vendor/napodan/prebuilt/gapps/system/lib/libgoogle_recognizer_jni.so:system/lib/libgoogle_recognizer_jni.so \
vendor/napodan/prebuilt/gapps/system/lib/libfrsdk.so:system/lib/libfrsdk.so \
vendor/napodan/prebuilt/gapps/system/lib/libpicowrapper.so:system/lib/libpicowrapper.so \
vendor/napodan/prebuilt/gapps/system/lib/libspeexwrapper.so:system/lib/libspeexwrapper.so \
vendor/napodan/prebuilt/gapps/system/etc/permissions/features.xml:system/etc/permissions/features.xml \
vendor/napodan/prebuilt/gapps/system/etc/permissions/com.google.widevine.software.drm.xml:system/etc/permissions/com.google.widevine.software.drm.xml \
vendor/napodan/prebuilt/gapps/system/etc/permissions/com.google.android.maps.xml:system/etc/permissions/com.google.android.maps.xml \
vendor/napodan/prebuilt/gapps/system/etc/permissions/com.google.android.media.effects.xml:system/etc/permissions/com.google.android.media.effects.xml \
